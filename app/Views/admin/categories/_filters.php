<div class="border-b border-slate-200 bg-slate-50/50 p-4">
    <form action="<?= current_url() ?>" method="get" class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="relative flex-1 max-w-md">
            ...
            <input
                ...
                placeholder="<?= esc($searchPlaceholder ?? 'Search records...') ?>"
        ...
        <div class="flex flex-wrap items-center gap-2.5">
            ...
            <!-- Items Per Page Dropdown (With Auto-Submit) -->
            <div class="relative">
            ...
            $hasPerPage = request()->getGet('per_page') !== null;
            ?>
            <?php if ($hasSearch || $hasStatus || $hasPerPage): ?>
