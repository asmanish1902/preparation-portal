        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500">
                    Add a single response choice or supplemental answer item to an existing question.
                </p>
            </div>
        </div>

        <a href="<?= route_to('admin.options.create') ?>" class="hidden sm:inline-flex items-center gap-1.5 text-xs font-semibold text-indigo-600 hover:text-indigo-800 transition">
            Switch to batch creation <i class="bx bx-right-arrow-alt text-base"></i>
        </a>
    </div>
